...
<?php
	$countComplaint = mysqli_query($conn, "SELECT * FROM complaint WHERE student_id = '{$_SESSION['LoginStudent']}'");
?>
						...
						?>
                                        <tr>
                                            ...
                                            <td style=" text-align:center !important;"><a href="show-complaint.php?id=<?=$row['complaint_id'];?>"><b><?=$row['complaint_text'];?></b></a></td>
