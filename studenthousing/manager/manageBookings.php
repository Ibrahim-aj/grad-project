                        ...
                        <div class="row col-md-12">
                          ...
                          <table>
                              ...
                              <?php
                                ...
                                if($booking->paid == FALSE && $booking->canceled == FALSE){
                                    echo "<tr>";
                          ...
                          <h4> هنا تعرض الحجوزات الغير مؤكدة ، لتأكيد الحجز اضغط على تاكيد الحجز </h4>
                          <a href="manageAllBookings.php" target="_top">عرض جميع الحجوزات</a>
