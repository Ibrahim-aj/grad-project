                         ...
                         <div class="container">
                          ...
                          <table>
                              ...
                              <?php
                                ...
                                $bookings = sh_bookings_get_by_student_id_without_check_canceled($request->student_id);
                                foreach($bookings as $booking){
                                    if($request->booking_id == $booking->booking_id){
                                        echo "<tr>";
                          ...
                          <a href="manageRequestChangeApartment.php" target="_top">عرض طلبات تغيير الشقة الغير موافق عليها</a>
