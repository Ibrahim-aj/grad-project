                  ...
                  <center><div class="btn btn-default " style="margin-bottom:15px;">عدد الشقق حاليا : <strong class="text-primary"><?php echo mysqli_num_rows($countApprts); ?></strong></div></center>
                    <h2>عرض الشقق</h2>
								<table id="zctb" class="display dataTable table table-striped table-bordered table-hover" cellspacing="0" width="100%" style="background-color:#fff;">
                                    <thead>
                                        <tr>
                                            <th style="width:25px; text-align:right !important;">رقم الشقة</th>
                                            <th style=" text-align:center !important;">عدد الطلاب الأقصى</th>
                                            <th style="text-align:center !important;">عدد الطلاب الحالي</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                        <?php 
						...
						?>
                                        <tr>
                                            <td style=" text-align:right !important;"><?=$row['apartment_id'];?></td>
                                            <td style=" text-align:center !important;"><?=$row['max_number_of_students'];?></td>
                                            <td style=" text-align:center !important;"><?=$row['current_number_of_students'];?></td>
                                        </tr>
                            <?php 
								}
							}else{
					    ?>
                                        <tr><td class="td2" colspan="3"><center>لا يوجد شقق حتى الأن</center></td></tr>
                        <?php } ?>
                                    </tbody>
                                </table>
                    </div>
