...
require_once('../db.php');
	...
	$countComplaint = mysqli_query($conn, "SELECT * FROM complaint WHERE status = '0'");

?>
<!DOCTYPE html>
<html>
<title>عرض الشكاوي والرد عليها </title>
    <head>
        <meta charset="UTF-8">
...
<div class="icon-bar w3-teal">
    ...
    <div class="w3-container" style="background-color:#D8DCF8">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-8 col-md-offset-2 ">
                  <center><div class="btn btn-default " style="margin-bottom:15px;">عدد الشكاوي في انتظار الرد : <strong class="text-primary"><?php echo mysqli_num_rows($countComplaint); ?></strong></div></center>
                    <h4>اضغط على اسم الشكوى للرد عليها  </h4>
<?php
...
?>
						...
						?>
                                        <tr>
                                            ...
                                            <td style=" text-align:center !important;"><div class="label label-warning">في انتظار الرد</div></td>
                                            <td style=" text-align:center !important;"><a href="show-complaint.php?delete=<?=$row['complaint_id'];?>"><i class="glyphicon glyphicon-trash"></i></a></td>
                                        </tr>
                            <?php 
								}
							}else{
