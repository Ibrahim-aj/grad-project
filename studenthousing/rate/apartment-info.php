...
$query = mysqli_query($conn, "SELECT * FROM booking WHERE student_id = '{$_SESSION['LoginStudent']}' And canceled ='0'  LIMIT 1 "); 
	...
	$queryAppartement = mysqli_query($conn, "SELECT * FROM apartment WHERE apartment_id = '{$book['apartment_id']}'");
...
<div class="color_forside w3-sidebar w3-bar-block w3-card-2 w3-animate-right" style="display:none;right:0;" id="rightMenu">
    <button onclick="closeRightMenu()" class=" w3-bar-item w3-button w3-large icon-bar w3-border" >إغلاق
        ...
        &times;</button>
    <!--SIDE BAR CONATINS-->
    <a href="../modifyStudentInfo.php"class="text w3-bar-item w3-button b ibrahim ">تعديل بيانات الطلاب</a>


    <a href="../index.php"class="text w3-bar-item w3-button b ibrahim w3-border">حجز شقة</a>
    <a href="../cancel-booking.php" class="w3-bar-item w3-button b w3-border ">الغاء حجز الشقة</a>
    <a href="../request-cancel-booking.php" class="w3-bar-item w3-button b w3-border">طلب تغيير الشقة</a>
    <a href="apartment-info.php" class="w3-bar-item w3-button b w3-border">بيانات الشقة</a>
    <a href="../rate/rate.php" class="w3-bar-item w3-button alignright  ul.b w3-border">تقييم الشقة</a>
    <a href="../complaint/Complaint.php" class="w3-bar-item w3-button b w3-border">إرسال شكوى</a>
    <a href="../complaint/complaint-view.php" class="w3-bar-item w3-button b w3-border">عرض الشكوى</a>
...
if(mysqli_num_rows($query) == 0 ){
	...
	// استعلام تقييم الشقة 
	$queryRates = mysqli_query($conn, "SELECT * FROM rate WHERE apartment_id = '{$book['apartment_id']}' ");
...
?>
                    ...
                    <div class="well col-lg-6" style="height:350px;"><img style="height:100%; width:100%" src="images/cover.jpg" class="img-responsive"></div>
                    <div class="well col-lg-4" style="min-height:350px;">
                      <ul class="list-group">
                        ...
                        <li class="list-group-item">تاريخ بداية الحجز <b style="font-family:Tahoma;" class="label label-primary pull-left"><?=$book['start_date'];?></b></li>
                        <li class="list-group-item">تاريخ نهاية الحجز <b style="font-family:Tahoma;" class="label label-danger pull-left"><?=$book['expire_date'];?></b></li>
                      </ul>
                    </div>
